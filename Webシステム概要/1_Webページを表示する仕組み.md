...
## なにこれ？  
ChromeやSafariなどのブラウザから、amazonやyoutubeなどのWebサイトを表示したことがある方は多いかと思います。  
...
## Webサイト表示の流れ
ブラウザのURL欄に開きたいWebサイトのURLを入力しEnterを押すと、そのWebサイトの画面がブラウザに表示されます。  
その際、ブラウザとWebサイトを供給しているWebサーバーの間でどのようなやりとりが行われているのでしょうか？

以下がWebサイトを表示する際の大まかな流れになります。     
