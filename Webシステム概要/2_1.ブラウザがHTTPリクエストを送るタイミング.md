...
### Webページ全体の再読み込み  
この記事では、画面が一度真っ白になり、ブラウザのタブの右に読み込みマークが表示される遷移のことを「Webページ全体の再読み込み」と呼ぶことにします。  
...
また、ブラウザ上のURLも変更されませんし、戻る・進むの履歴も変化しません。　　
...
このようなAjaxによる画面の変更をサイト全体の規模で行っているものをSPAと呼びます。  
